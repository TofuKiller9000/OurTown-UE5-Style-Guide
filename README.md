# [Our Town] UE5 Style Guide() {

*A mostly reasonable approach to Unreal Engine 5*

Based upon [Gamemakin](https://gamemak.in/) UE5 Style Guide.
...
<a name="0.1"></a>
### 0.1 Respect the Guide

The purpose of a style guide is to remove time-wasting ambiguity and guesswork. Artists can focus on their creative work while programmers and engineers can quickly find what they need and easily maintain a project.

Style guides should be living documents. If at any point you feel that a certain aspect of the style guide is not working, please bring it forward to the group if you feel it would benefit usage to all.
...
It also allows for more productive creation and maintenance as one does not need to think about style. Follow the instructions. This style guide is written with best practices in mind, meaning that by following this style guide you will also minimize hard-to-track issues.
...
Having a style guide puts us above other indie studios that do not have this level of organization and commitment. It cements our ability to work as a team. 
...
If you are unfamiliar with what the Developers Folder is, [click here](https://youtu.be/OvxJXQvQQts?si=pY3G9oAr7mxQh_q3)
